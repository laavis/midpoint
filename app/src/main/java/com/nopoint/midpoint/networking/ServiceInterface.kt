...
interface ServiceInterface {
    ...
    fun post(path: String, params: JSONObject, auth: String, completionHandler: (response: JSONObject?) -> Unit)
    fun get(api: API, path: String, completionHandler: (response: JSONObject?) -> Unit)
    fun get(path: String, auth: String, completionHandler: (response: JSONObject?) -> Unit)
}